    ...
    try {
        ...
        const codeMap = {
            ...
            "abloodymoonandabeatensun":
                ...
                Il controllo dei parassiti non è necessario, sia nel cibo che nel corpo.
                ...
                Un (1) Risultato Aggiuntivo: 
                Nota di Archibald per Valtr
                ...
                Ti trovi su un'isola al largo della costa di un'altra isola più grande che un tempo esisteva vicino al Polo Nord della Terra. È una piccola isola, e ci sono solo altri 50 avamposti là fuori, presidiati da altre 49 persone. Dalla sua origine, la Terra ha avuto un solo continente: l'Asia, con Cina, Africa Orientale e Oceania come parti principali del continente. 
                Abbiamo alcune prove dell'esistenza di continenti precedenti, prima che L'Infante li raggiungesse. Il tuo compito è semplice. Uccidi L'Infante. Il nome del Bambino è Smith, e lui non esiste. Come lo realizzerai dipende da te, ma prenditi il tuo tempo. Hai tutto il tempo del mondo.
                ...
                Ricordati di noi. Se non riuscirai a ricordarti di me, ricordati almeno della piccola Zeta. Il mio tesoro avrà bisogno di qualcuno a cui far affidamento là fuori.
                Ricordati di lei.
                `
                ,
